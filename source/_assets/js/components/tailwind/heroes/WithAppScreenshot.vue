  ...
  <div class="bg-gray-50">
    ...
    <div class="bg-gray-800">
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <h2 class="text-center text-gray-400 text-sm font-semibold uppercase tracking-wide">{{ logoText }}</h2>
        <div class="mt-8 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
          <div class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1" v-for="logo in logos">
            <img class="h-12" :src="logo.image" :alt="logo.alt ?? 'Logo'" />
          </div>
        </div>
      </div>
    </div>
