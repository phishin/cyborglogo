        ...
        <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
          <div class="flex items-center flex-1">
            ...
            <div class="hidden space-x-10 md:flex md:ml-10">
              <a v-for="item in navigation" :key="item.name" :href="item.href" class="font-medium text-white hover:text-gray-300">{{ item.name }}</a>
            </div>
          </div>
          ...
          <div class="lg:grid lg:grid-cols-12 lg:gap-8">
            <div class="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
              <div>
                ...
                <p class="mt-8 text-sm text-white uppercase tracking-wide font-semibold sm:mt-10">{{ logosText }}</p>
                <div class="mt-5 w-full sm:mx-auto sm:max-w-lg lg:ml-0">
                  <div class="flex flex-wrap items-start justify-between">
                    <div class="flex justify-center px-1" v-for="logo in logos">
                      <img class="h-9 sm:h-10" :src="logo.image" :alt="logo.alt ?? 'Logo'" />
                    </div>
                  </div>
                </div>
              </div>
