<div class="relative overflow-hidden" x-data="{menuOpen: false}">
    <header class="relative">
                ...
                <div class="flex items-center flex-1">
                    <div class="flex items-center justify-between w-full md:w-auto">
                        ...
                        <div class="-mr-2 flex items-center md:hidden">
                            <button x-on:click="menuOpen = true" x-on:click.outside="menuOpen = false" type="button" class="bg-gray-900 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-800 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white" aria-expanded="false">
        ...
        <div class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top md:hidden" x-show="menuOpen"
                    ...
                    <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                        <div class="lg:py-24">
                            ...
                            <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                ...
                                <span class="block text-indigo-400">{{ $colorTitle }}</span>
                            </h1>
                                ...
                                <form action="#" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                                    <div class="sm:flex">
                                        ...
                                        <div class="mt-3 sm:mt-0 sm:ml-3">
                                            <button type="submit" class="block w-full py-3 px-4 rounded-md shadow bg-indigo-500 text-white font-medium hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 focus:ring-offset-gray-900">{{ $emailButtonText }}</button>
                                        </div>
                                    </div>
                                    <p class="mt-3 text-sm text-gray-300 sm:mt-4">{{ $subText }}</p>
                                </form>
                            </div>
                        </div>
                    </div>
